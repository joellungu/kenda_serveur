...
public class UtilisateurController {
    ...
    public Response setOne(@QueryParam("telephone") String telephone) {
        //
    ...
    public Response enregistrerUtilisateur(Utilisateur utilisateur){
        ...
        if (utilisateur1 != null) {
            //
            utilisateur1.noms = utilisateur.noms;
            utilisateur1.genre = utilisateur.genre;
            utilisateur1.fbToken = utilisateur.fbToken;
            //
            return Response.ok(utilisateur).build();
        }
